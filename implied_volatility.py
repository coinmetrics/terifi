...
async def fetch_iv_for_expiry(client, markets, expiry_date, days_before_expiry=22, granularity="1d"):
    """
...
async def save_implied_volatility_data(start_date, end_date, days_before_expiry=22, granularity="1d"):
    """
