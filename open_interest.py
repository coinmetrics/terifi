...
async def fetch_oi_for_expiry(client, markets, expiry_date, days_before_expiry=22):
    """
...
async def save_open_interest_data(start_date, end_date, days_before_expiry=22):
    """
