...
async def fetch_prices_for_expiry(client, markets, expiry_date, days_before_expiry=22):
    """
...
async def save_contract_price_data(start_date, end_date, days_before_expiry=22):
    """
